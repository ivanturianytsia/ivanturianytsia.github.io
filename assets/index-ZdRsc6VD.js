...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function bs(e,t,n){let r=new Float32Array(os),i=new G(0,1,0);return new va({name:`SphericalGaussianBlur`,defines:{n:os,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Cs(),fragmentShader:`
	...
	`}var ws=class extends Gt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ra(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;continue}if((u=l.match(i))&&(c.gamma=parseFloat(u[1])),(u=l.match(a))&&(c.exposure=parseFloat(u[1])),(u=l.match(o))&&(c.valid|=2,c.format=u[1]),(u=l.match(s))&&(c.valid|=4,c.height=parseInt(u[1],10),c.width=parseInt(u[2],10)),c.valid&2&&c.valid&4)break}return c.valid&2||t(3,`missing format specifier`),c.valid&4||t(3,`missing image size specifier`),c},i=function(e,n,r){let i=n;if(i<8||i>32767||e[0]!==2||e[1]!==2||e[2]&128)return new Uint8Array(e);i!==(e[2]<<8|e[3])&&t(3,`wrong scanline width`);let a=new Uint8Array(4*n*r);a.length||t(4,`unable to allocate buffer space`);let o=0,s=0,c=4*i,l=new Uint8Array(4),u=new Uint8Array(c),d=r;for(;d>0&&s<e.byteLength;){s+4>e.byteLength&&t(1),l[0]=e[s++],l[1]=e[s++],l[2]=e[s++],l[3]=e[s++],(l[0]!=2||l[1]!=2||(l[2]<<8|l[3])!=i)&&t(3,`bad rgbe scanline format`);let n=0,r;for(;n<c&&s<e.byteLength;){r=e[s++];let i=r>128;if(i&&(r-=128),(r===0||n+r>c)&&t(3,`bad scanline data`),i){let t=e[s++];for(let e=0;e<r;e++)u[n++]=t}else u.set(e.subarray(s,s+r),n),n+=r,s+=r}let f=i;for(let e=0;e<f;e++){let t=0;a[o]=u[e+t],t+=i,a[o+1]=u[e+t],t+=i,a[o+2]=u[e+t],t+=i,a[o+3]=u[e+t],o+=4}d--}return a},a=function(e,t,n,r){let i=2**(e[t+3]-128)/255;n[r+0]=e[t+0]*i,n[r+1]=e[t+1]*i,n[r+2]=e[t+2]*i,n[r+3]=1},o=function(e,t,n,r){let i=2**(e[t+3]-128)/255;n[r+0]=ur.toHalfFloat(Math.min(e[t+0]*i,65504)),n[r+1]=ur.toHalfFloat(Math.min(e[t+1]*i,65504)),n[r+2]=ur.toHalfFloat(Math.min(e[t+2]*i,65504)),n[r+3]=ur.toHalfFloat(1)},c=new Uint8Array(e);c.pos=0;let l=r(c),u=l.width,d=l.height,f=i(c.subarray(c.pos),u,d),p,m,h;switch(this.type){case g:h=f.length/4;let e=new Float32Array(h*4);for(let t=0;t<h;t++)a(f,t*4,e,t*4);p=e,m=g;break;case _:h=f.length/4;let t=new Uint16Array(h*4);for(let e=0;e<h;e++)o(f,e*4,t,e*4);p=t,m=_;break;default:throw Error(`THREE.HDRLoader: Unsupported type: `+this.type)}return{width:u,height:d,data:p,header:l.string,gamma:l.gamma,exposure:l.exposure,type:m,colorSpace:Be,minFilter:s,magFilter:s,generateMipmaps:!1,flipY:!0}}setDataType(e){return this.type=e,this}};function hf(e,t){let n=Et.degToRad(90-e),r=Et.degToRad(180+t);return new G().setFromSphericalCoords(1,n,r)}function gf(e,t){let n=hf(Uu.elevation,Uu.azimuth),r=!1,i=null;return new mf(t).loadAsync(Gu.url).then(t=>{if(r){t.dispose();return}t.mapping=303,i=t,e(t)}).catch(e=>{console.error(`Could not load ${Gu.url}`,e)}),{sunDirection:n,dispose(){r=!0,e(null),i?.dispose(),i=null}}}function _f(e){let t=new Sn;t.name=`world`;let n=gf(e.applyOutside,e.loadingManager),r=bf(n.sunDirection),i=()=>{r.light.shadow.needsUpdate=!0},a=cf(e.loadingManager,i),o=Xu(e.renderer,i,e.loadingManager);return t.add(a.group),t.add(r.group),t.add(yf()),t.add(o.group),{root:t,environmentIntensity:Ku.environmentIntensity,backgroundBlurriness:Gu.blurriness,backgroundIntensity:Gu.intensity,outsideRotation:new rn(0,Et.degToRad(Gu.rotationDeg),0),exposure:Ku.exposure,spawn:{position:new G(qu.x,qu.eye,qu.z),yaw:Et.degToRad(qu.yaw),pitch:Et.degToRad(qu.pitch)},update(){},dispose(){n.dispose(),a.dispose(),o.dispose(),Au(t)}}}var vf=14;function yf(){let{bounce:e}=Ku,t=new ro(new X(e.fromAbove),new X(e.fromBelow),e.intensity);return t.name=`bounce`,t}function bf(e){let t=new Sn;t.name=`sun`;let n=new Co(new X(Uu.color),Uu.intensity);n.position.copy(e).multiplyScalar(vf),n.castShadow=!0,n.target.position.set(0,Vu.height*.35,0);let{shadow:r}=n;r.mapSize.set(Wu.mapSize,Wu.mapSize);let i=r.camera;return i.left=-Wu.extent,i.right=Wu.extent,i.top=Wu.extent,i.bottom=-Wu.extent,i.near=.5,i.far=26,i.updateProjectionMatrix(),r.autoUpdate=!1,r.needsUpdate=!0,r.normalBias=.02,r.bias=-2e-4,t.add(n),t.add(n.target),{group:t,light:n}}var xf=document.querySelector(`#stage`);if(xf===null)throw Error(`#stage canvas is missing from index.html`);var Sf=document.querySelector(`#hint`),Cf=Ou(xf),wf=_u(Cf.camera,xf,{onFirstLook:()=>Sf?.setAttribute(`data-dismissed`,`true`)}),Tf=e=>{Cf.scene.background=e,Cf.scene.environment=e},Ef=Su(),Df=Eu(),Of=kf(_f({renderer:Cf.renderer,applyOutside:Tf,loadingManager:Df.manager}),!0);Cf.onFrame(e=>{wf.update(e),Of.update(e)}),Df.reveal(()=>Cf.renderer.compileAsync(Cf.scene,Cf.camera)).then(()=>Ef.arm());function kf(e,t){return Cf.scene.add(e.root),Cf.scene.environmentIntensity=e.environmentIntensity,Cf.scene.backgroundBlurriness=e.backgroundBlurriness,Cf.scene.backgroundIntensity=e.backgroundIntensity,Cf.scene.backgroundRotation.copy(e.outsideRotation),Cf.scene.environmentRotation.copy(e.outsideRotation),Cf.renderer.toneMappingExposure=e.exposure,t&&(Cf.camera.position.copy(e.spawn.position),wf.setOrientation(e.spawn.yaw,e.spawn.pitch)),e}